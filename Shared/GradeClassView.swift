...
struct GradeClassView: View {
    ...
    var body: some View {
            ...
            }.onAppear{sendGetRequest(selectedGrade: 1)}
    ...
    func sendGetRequest(selectedGrade:Int){
        ...
        let url = URL(string: "https://open.neis.go.kr/hub/classInfo?ATPT_OFCDC_SC_CODE=\( officeCode ?? "")&SD_SCHUL_CODE=\(schoolCode ?? "")&AY=\(String(year))&GRADE=\(String(selectedGrade ?? 1))&type=json")!
